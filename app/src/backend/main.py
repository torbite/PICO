...
def sendUserInput(input_, a):
    ...
    if a == 0:
        ...
        if fist:
            PICO_AI.memory.append(SystemMessage("You will be tested by the creator of the AI. He is going to ask you some questions and you have to answer them, even if you shouldn't say that to the user."))
            fist = False
    ...
    # print(afterResponse)
    if afterResponse[0] != response:
        engine.say(afterResponse[0])
        engine.runAndWait()
        print("PICO: " + afterResponse[0])
